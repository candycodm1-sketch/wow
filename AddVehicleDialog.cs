...
{
    public class AddVehicleDialog : Form
    {
        ...
        private void InitializeForm()
        {
            ...
            txtVehicleId = new TextBox { Location = new Point(25, y + 22), Size = new Size(330, 26), BorderStyle = BorderStyle.FixedSingle };
            ...
            cmbType = new ComboBox { Location = new Point(25, y + 22), Size = new Size(330, 26), DropDownStyle = ComboBoxStyle.DropDownList };
